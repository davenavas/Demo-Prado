var counter = 0;
var responses = ["Hola Lorena, cúal su pregunta el dia de hoy?","Solo para confirmar, desea conocer qué es deducción de gastos personales?","Perfecto, tenemos toda la informacion que necesita en el siguiente link: <a href='topic.html#subtopic5' type='button' class='btn btn-link' ><i class='fas fa-stamp'></i> Deducción de gastos Personales para Personas naturales</a>","De nada, espero haber resuelto su pregunta. Desea hacer alguna otra pregunta?","No tengo una respuesta en mi conocimiento. Desea usar una de sus 3 consultas directas a un experto disponibles este mes?","Por favor, escriba su pregunta lo más clara posible (y en menos de 250 caracteres)","Listo, un experto le responderá en los proximos días. Recuerde que le quedan 2 consultas directas este mes. Que tenga un buen día."];
(function($) {
